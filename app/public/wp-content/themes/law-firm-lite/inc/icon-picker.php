...
class Law_Firm_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'law-firm-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $law_firm_lite_font_awesome_icon_array = law_firm_lite_font_awesome_icon_array();
                    foreach ($law_firm_lite_font_awesome_icon_array as $law_firm_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $law_firm_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($law_firm_lite_font_awesome_icon).'"></i>
                            <span class="law-firm-lite-social-class">'.esc_attr($law_firm_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function law_firm_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'law-firm-lite-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'law_firm_lite_customizer_script' );

if(!function_exists('law_firm_lite_font_awesome_icon_array')){
    function law_firm_lite_font_awesome_icon_array(){
