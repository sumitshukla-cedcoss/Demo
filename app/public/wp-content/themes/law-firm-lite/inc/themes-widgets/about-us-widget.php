...
class Law_Firm_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Law_Firm_Lite_About_Widget',
			__('VW About us', 'law-firm-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'law-firm-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','law-firm-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','law-firm-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','law-firm-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','law-firm-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','law-firm-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','law-firm-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function law_firm_lite_about_custom_load_widget() {
	register_widget( 'Law_Firm_Lite_About_Widget' );
}
add_action( 'widgets_init', 'law_firm_lite_about_custom_load_widget' );