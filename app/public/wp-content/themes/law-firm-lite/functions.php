...
function law_firm_lite_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'law-firm-lite' ) .'</h3>';
	echo '<p>'. esc_html__( 'Thank you for choosing Law Firm Theme. Would like to have you on our Welcome page so that you can reap all the benefits of our Law Firm Theme.', 'law-firm-lite' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=law_firm_lite_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'law-firm-lite' ) .'</a></p>';
	echo '</div>';
}
...
function law_firm_lite_scripts() {	
	...
	wp_enqueue_script( 'law-firm-lite-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
function law_firm_lite_sanitize_email( $email, $setting ) {
...
//define
define('LAW_FIRM_LITE_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-law-firm-lite/','law-firm-lite'));
...
define('LAW_FIRM_LITE_BUY_NOW',__('https://www.vwthemes.com/themes/law-firm-wordpress-theme/','law-firm-lite'));
define('LAW_FIRM_LITE_LIVE_DEMO',__('https://www.vwthemes.net/vw-law-firm-pro/','law-firm-lite'));
define('LAW_FIRM_LITE_PRO_DOC',__('https://www.vwthemesdemo.com/docs/law-firm-pro/','law-firm-lite'));
...
define('LAW_FIRM_LITE_CREDIT',__('https://www.vwthemes.com/themes/free-law-firm-wordpress-theme/','law-firm-lite'));
